...
<html>
<head>
    <title>Fund Account | DigitalCryptoCoin</title>
    <meta charset="utf-8">
...
<div class="row">
        ...
        <div class="col-md-8">
        <div class="white-box">
            <h3 class="box-title m-b-0">Fund your account</h3>
            <p class="text-muted m-b-30 font-13"> Please make sure to follow the instructions after submitting the form
                to activate your investment </p>
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="amount" id="amount"
                                placeholder="Enter amount you wish to fund your account with">
                        </div>
                    </div>
                </div>
