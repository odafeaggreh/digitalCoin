...
<html>
<head>
    <title>My Plans | DigitalCryptocoin</title>
    <meta charset="utf-8">
...
<!--------------------
            ...
            <div class="content-w">
                ...
                <?php
                     if (isset($_POST['bronze'])) {
                        $depositeAmount = $_POST['bronze'];
                     }elseif (isset($_POST['silver'])) {
                        $depositeAmount = $_POST['silver'];
                     }elseif(isset($_POST['gold'])) {
                        $depositeAmount = $_POST['gold'];
                     }elseif(isset($_POST['platinum'])){
                        $depositeAmount = $_POST['platinum'];
                     }
                ?>
    ...
    <div class="col-xs-12">
        <h5 class="page-title text-uppercase">Company Billing Details</h5>
            ...
            <div class="white-box">
                <p></p>
                <p class="box-title m-b-0"> You are to deposite a minimim of <strong>$<?php echo $depositeAmount;?> </strong> to the company account details below. afterwhich you should contact your investment manager for proper plan activation.</p>
