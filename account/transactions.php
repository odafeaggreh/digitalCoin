...
<div class="col-md-12">
        <div class="panel">
            <div class="table-responsive">
                <table class="table table-padded table-hover manage-u-table">
                    <thead>
                        <tr>
                            <th>
                                  Transaction Id
                    ...
                    <tbody>
                                           <td colspan='5'>* This is a complete history of all transactions that took place on your trade account.</td>
                            </tr>                     
                    </tbody>
                </table>
            </div>
