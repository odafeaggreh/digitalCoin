        ...
        <div class="page-content">
                        ...
                        <div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
                           <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                <ul>
                                    ...
                                    border-width:0px;">
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                   		<span class="text-primary" style="padding-right:10px;">Crypto</span><span class="text-white">Investment</span>
                                    </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;">We are a team of PROFESSIONAL TRADERS with EXPERTISE in one of the biggest financial markets of today, the CRYPTOCURRENCY. Our focus is to provide our affiliates with daily and constant profits in these markets.</span>
                                    </div>
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                    	<span class="text-white" style="padding-right:10px;">Trade</span><span class="text-primary">Binary,</span>
                                    </div>
                                    ...
                                    border-width:0px;">
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                   		<span class="text-primary" style="padding-right:10px;">ETF &</span><span class="text-white">Forex</span>
                                    </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;">DigitalCryptoCoin is one of the fastest growing online trading brands in the world! Voted the best mobile trading platform, we have now expanded our offerings to include stock trading, ETF trading, Forex trading and a brand-new product unique to DigitalCryptoCoin</span>
                                    </div>
                                    ...
                                    border-width:0px;">
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                    	<span class="text-white" style="padding-right:10px;">Easy Way</span><span class="text-primary">to Invest</span>
                                    </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;">High accuracy in prices, no restriction on trades, even on accounts with minimum deposits, and a wide choice of trading opportunities is the pillar of our business activity.</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-9 col-sm-9">
                                        <div class="call-to-action-left p-tb20 ">
                                            <h4 class="text-uppercase m-b10 font-weight-600">DigitalCryptoCoin is a true opportunity to earn in the Financial Market</h4>
                                            <p>Beginners can trade Bitcoin with DigitalCryptoCoin just as well as experienced traders. The entire process is fully automated. Bitcoin traders are aware of their profits in advance — their main objective is to select the correct direction of the market movement.</p>
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <div class="call-to-action-right p-tb30">
                                            <a href="register.php" class="site-button-secondry text-uppercase font-weight-600">
                                                Sign Up 
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="wt-box text-right">
                            	<div class="section-head text-center">
                                 	 <h5 class="text-uppercase">A Glimpse of Forex Trading</h5>
                        <div class="wt-separator-outer"><div class="wt-separator bg-primary"></div></div>
                        <p> Predict the direction of the financial Market and start making profits, Beginners are welcome to use our automated trading software.</p>
                        ...
                        <div class="col-md-6">
                            <div class="wt-right-part p-b80">
                                    ...
                                    <div class="section-head text-left">
                                        <span class="wt-title-subline font-16 text-gray-dark m-b15">Why choose us?</span>
                                        <h2 class="text-uppercase">Automated trading bots in the cloud</h2>
                                        <div class="wt-separator-outer"><div class="wt-separator bg-primary"></div></div>
                                    </div>
                                    <!-- TITLE END -->
                                    <div class="section-content">
                                        <div class="wt-box">
                                            <p>
                                                <strong>Trading is a revolutionary way of earning in the financial markets, which is very straightforward, quick, and extremely lucrative. You probably know that financial markets are venues where currencies, such as the dollar, the euro, or the pound, are traded 24/7, with no breaks or days off whatsoever.
                                                </strong>
                                            </p>
                                            <p>One of the factor that stands us out from the rest brokerage firm is the fact that we allow beginners take advantage of trades using an automated system that maximises profit on any trade and ensure right trades are made and these trades are monitored and executed properly. Our trading system deals mainly with bitcoin and we don't trade on manual predictions that are psychologically influenced and may result in errors, we trade with softwares and bot algorithms that guarantee a full profit after a stipulated trade period. .</p>
                                            <a href="register.php" class="site-button text-uppercase m-r15">Start Earning</a>
                                            <a href="contact.php" class="site-button-secondry text-uppercase">Contact us</a>
                                        </div>
                                    </div>                                	
                                </div>
                        </div>
            ...
            <div class="section-full  p-t80 p-b80 bg-gray">
            	<div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                    	<span class="wt-title-subline font-16 text-gray-dark m-b15">Open an Account for free and start trading now!</span>
                        <h2 class="text-uppercase">Our Quality Features</h2>
                        <div class="wt-separator-outer">
                            <div class="wt-separator bg-primary"></div>
                        </div>
                        <p>DigitalCryptoCoin is one of the world’s fastest growing Cryptocurrency, Binary, Forex and CFD brands, offering advanced yet user-friendly proprietary trading platforms.</p>
                    </div>
                    <!-- TITLE END-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Very Easy To Fund your live trading account and start earning using our modern tools, we perform excellently amongst our competitions.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 2 -->
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content ">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Legal Company</h4>
                                        <p>DigitalCryptoCoin LTD is a company registered in the United Kingdom providing its investment services to members all around the world.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>We offer very light volume investment plans to suit the needs of all members.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 5 -->
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">24X7 Support Services</h4>
                                        <p>We understand how important having reliable  support service is to you. Please don't hesitate to contact us should you have any questions or concerns we will get back to you in no time</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 6 -->
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Instant Withdrawals</h4>
                                        <p>We are deeply committed to providing our clients with the best Investment solutions. Withdrawals are all processed instantly after they are requested.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-6">
                            <div class="awesome-counter text-right text-white">
                                ...
                                <p>As a leading online broker, DigitalCryptoCoin was one of the first to offer trading CFDs on cryptocurrencies. With five of the most popular digital currencies currently available for trading as CFDs, we are always looking for the latest popular currency so that we can make a CFD of it available to our traders. Our education center will help take the mystery from cryptocurrencies so you can trade CFDs with greater confidence. And with our easy to use trading platform you’ll soon find it more accessible than ever to trade CFDs on your favorite underlying digital currency online.</p>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="status-marks  text-white m-tb10">
                                        <div class="status-value text-right">
                                            <span class="counter">9150</span>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="status-marks  text-white m-tb10">
                                        <div class="status-value text-right">
                                            <span class="counter">315223</span>
            ...
            <div class="section-full  p-t80 p-b80 bg-gray">
            	<div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                    	<span class="wt-title-subline font-16 text-gray-dark m-b15">Three steps to start Earning</span>
                        <h2 class="text-uppercase">How It Works</h2>
                        <div class="wt-separator-outer"><div class="wt-separator bg-primary"></div></div>
                        <p> A digital currency, also known as cryptocurrency, is created through the use of specialized software and is stored only in a digital form on computers and servers throughout the world. Since then many other digital currencies have come on the scene, with even more appearing on a monthly basis. Yet Bitcoin is still the king when it comes to digital currencies</p>
                    </div>
                    <!-- TITLE END-->
                    <div class="section-content no-col-gap">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Register your trading account.</h4>
                                        <p>It takes less than 5 minutes to sign up on DigitalCryptoCoin. click on Join us above and create your account.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 2 -->
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-secondry m-a5 ">
                                    ...
                                    <div class="icon-content text-white">
                                        ...
                                        <p>Log into your already created account and deposit your capital through the available investment gateway.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Start Trading & Earning</h4>
                                        <p>Predict the direction of the financial Market and start making profits, Beginners are welcome to use our automated trading software.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                        	<div class="col-md-6  clearfix">
                            	<div class="bit-converter p-a40 p-b15 bg-white">
                                	<div class="wt-box">
                                        ...
                                        <p>Transactions are verified by network nodes through cryptography and recorded in a public distributed ledger called a blockchain.</p>
                                    </div>
                                	<div class="currency-calculator sp-one">
                                    	<div class="btc-clc">
											<script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script type="text/javascript" src="js/calc_widget.js"></script>
                                        </div>
                                    </div>
                                </div>                               
                            </div>
                            <div class="col-md-6">
                            	<div class="wt-box graph-part-right text-white">
                                    ...
                                    <span class="text-uppercase text-primary display-block title-second">Investors have thousands of opportunities to trade assets online</span>
                                    <p><strong>Speculate on the price dynamics of the most popular trading assets with various kinds of Options (Binary, Digital, FX).</strong></p>
                                    <ul class="list-check-circle primary">
                                        <li>The price reflects the overall stability of an asset; there are many elements that affect the market and these are reflected in the share price </li>
                                        <li>Prices move in trends; this is pretty straightforward; prices always move in trends, upward and downward, depending on the circumstances that occur in each moment in the markets.</li>
                                        <li>History repeats itself; certain trends in the markets tend to reoccur again and again.</li>
                                        <li>Trade the hottest cryptocurrencies of 2020: Bitcoin, Ethereum, Litecoin and others.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-full text-center wt-our-team bg-gray p-t80 p-b50">
                <div class="container">
                    ...
                    <!-- TABLE RESPONSIVE -->
                    <div class="section-head text-center">
                        <h2 class="text-uppercase">Forex Trading Chart</h2>
                        <div class="wt-separator-outer"><div class="wt-separator bg-primary"></div></div>
                        <p>Forex Trading is a revolutionary way of earning in the financial markets, which is very straightforward, quick and extremely lucrative. You probably know that the financial markets are venues where currencies such as the dollar, the euro, or the pound are traded 24/7, with no breaks or days off whatsoever. With a good strategy and fantastic signal, your profit is guaranteed.</p>
                    </div>
                    
<!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div id="tradingview_7895b"></div>
  <div class="tradingview-widget-copyright"><a href="https://www.tradingview.com/symbols/OANDA-USDJPY/" rel="noopener" target="_blank"><span class="blue-text"></span></a></div>
  <script type="text/javascript" src="s3.tradingview.com/tv.php"></script>
  ...
  "container_id": "tradingview_7895b"
}
  );
  </script>
</div>
...
<!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div id="tradingview_81fb4"></div>
  <div class="tradingview-widget-copyright"><a href="https://www.tradingview.com/symbols/USDJPY/?exchange=OANDA" rel="noopener" target="_blank"><span class="blue-text">USDJPY Chart</span></a> by TradingView</div>
  ...
  "enable_publishing": false,
  "allow_symbol_change": true,
  "container_id": "tradingview_81fb4"
}
  );
  </script>
</div>
<!-- TradingView Widget END -->
                            	...
                            	<div class="section-content p-tb60 p-r30 clearfix">
                                	<div class="wt-left-part any-query">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <p class="text-white">We provide 24/7 customer support through e-mail. Our support representatives are always available to answer any questions.</p>
                                            <h4 class="text-primary"><a href="mailto: digitalcryptocoin2@gmail.com" class="__cf_email__" data-cfemail="">support@digitalcryptocoin.com</a> </h4>
                                        </div>    
                                    </div>
                                </div>                               
                            </div>
                            	...
                            	<div class="section-content p-tb60 p-l30 clearfix">
                                    <div class="wt-right-part any-query-contact">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <p class="text-white">Informations about your activities on our website is private and can't be accessed by third parties. Fill the contact form below or simply send us an email for futher enquiries.</p>
                                            <h4 class="text-secondry"><a href="mailto: digitalcryptocoin2@gmail.com" class="__cf_email__" data-cfemail="">support@digitalcryptocoin.com</a></h4>
                                        </div>                               
                                    </div>                                
                                </div>
                            </div>
            ...
            <div class="section-full overlay-wraper bg-center bg-cover bg-no-repeat  bg-gray" style="background-image:url(images/background/bg2.jpg)">
                ...
                <div class="container">
							...
							<div class="col-md-7 col-sm-7">
                            	<div class="section-content p-tb70">
                                        ...
                                        <div class="section-head text-left text-white">
                                            <h2 class="text-uppercase">CRYPTO INVESTMENT BEYOND THE ORDINARY</h2>
                                            <div class="wt-separator-outer">
                                                <div class="wt-separator bg-primary"></div>
                                            </div>
                                        </div>
					...
					<iframe src="https://www.youtube.com/embed/Um63OQz3bjo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
            ...
            <div class="section-full p-t80 p-b50 bg-center bg-full-height bg-no-repeat"  style="background-image:url(images/background/bg-testimonial.jpg);">
                <div class="container">
                    <!-- TITLE START -->    
                    <div class="section-head text-center">
                    	<span class="wt-title-subline font-16 text-gray-dark m-b15">Some valuable words from our loving and ever growing customers.</span>
                        ...
                        <div class="owl-carousel home-carousel-1">
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        ...
                                        <p>I have only been a member for a few days and i have already earned a decent amount of money. Finally a real and honest company that does what it says. Thank you so much for this great opportunity!
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">ALEX GLYSON</strong>
                                        <span class="testimonial-position text-primary p-t10">New Customer</span>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left text-primary"></span>
                                        <p>Am an engineer in Washington DC when an account manager KLOE AURORA brought this opportunity to me I just said casually to invest with $500 but my story today is on a premium plan.
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">SCOTT SMITH</strong>
                                        <span class="testimonial-position text-primary p-t10">Engineer</span>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left text-primary"></span>
                                        <p>Thanks for helping me with the best of all time trading platforms, with a minimum of your basic plan platform it yielded a lot for me and I was paid without stress.
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">MOSES SHERMAN</strong>
                                        <span class="testimonial-position text-primary p-t10">Investor</span>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left text-primary"></span>
                                        <p>The execution speed is top notch and also the customer support, happy i am with you guys 
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">RUKKY SANDERS</strong>
                                        <span class="testimonial-position text-primary p-t10">STUDENT</span>
                                    </div>
                                </div>
